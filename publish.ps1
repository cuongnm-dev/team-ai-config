...
# Templates baked vào MCP image (D:\MCP Server\etc-platform\src\etc_platform\assets\registry\templates)
# Khi sửa ref-*.md ở ~/.claude/skills/, đồng bộ sang MCP source rồi build image mới qua release-mcp.ps1.
