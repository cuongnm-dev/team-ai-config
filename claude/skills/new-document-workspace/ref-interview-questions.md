...
Prerequisite SOFT: NCKT (NĐ 45/2026 Đ12) [có → load nckt.sections § 4 (mục tiêu) + § 6 (CN/KT/TB) + § 8 (TKCS sizing) + § 14 (TMĐT) / chưa → OK, hỏi thêm]
...
## Interview: NCKT (DT-08) — 25 câu (NĐ 45/2026 Đ12)

Outline IMMUTABLE: `nghien-cuu-kha-thi/nd45-2026.md` (19 chương + Phụ lục).
Render: etc-platform → `bao-cao-nghien-cuu-kha-thi.docx`. Specialist agent: `tdoc-nckt-writer`.
...
1. [§1.1] Thông tin chung: tên DA, mã DA, chủ đầu tư, đơn vị thụ hưởng, địa điểm,
   sản phẩm đầu ra dự kiến?

2. [§1.2] Văn bản pháp lý lập DA (≥ 7 văn bản):
   → Luật ĐTC 58/2024, Luật Đấu thầu 22/2023, NĐ 45/2026, NĐ 214/2025,
     NĐ 85/2016, TT 04/2020, TT 12/2022, QĐ 749/QĐ-TTg, CT 34/CT-TTg,
     QĐ phê duyệt Đề án CĐS của Bộ/Tỉnh, văn bản chuyên ngành?

3. [§1.3] Yêu cầu ATTT của dự án (7 mục): bảo vệ nội dung — tài chính —
   giải pháp KT — danh sách thiết bị — tài liệu/báo cáo — tiến độ — giám sát?

═══ Chương 2 — Sự cần thiết ═══

4. [§2.1] Hiện trạng tổ chức + nghiệp vụ: số lượng đơn vị, biên chế, quy mô?

5. [§2.2] Hiện trạng UD CNTT + nhân lực CNTT (số liệu cụ thể):
   a) Hệ thống PM hiện có?
   b) Số lượng chuyên viên CNTT? Trình độ?

6. [§2.3] Hạ tầng CNTT hiện trạng:
   a) Trung tâm dữ liệu: vỏ trạm, UPS, PCCC?
   b) Máy chủ — lưu trữ — mạng — ATTT cấp độ?
   c) Các DA CNTT đang triển khai (kế thừa được gì)?

7. [§2.4] Sự cần thiết đầu tư (ĐỊNH LƯỢNG — bắt buộc):
   a) Khối lượng hồ sơ/giao dịch hiện tại/năm?
   b) Thời gian xử lý trung bình?
   c) Tỷ lệ thủ công vs tự động?
   d) Chi phí vận hành hiện tại/năm?

═══ Chương 3-4 — Quy hoạch + Mục tiêu ═══

8. [§3] Phù hợp quy hoạch:
   a) Kiến trúc CPĐT cấp Bộ/Tỉnh đã ban hành phiên bản nào?
   b) Quy hoạch CNTT ngành (nếu có)?

9. [§4.1] Mục tiêu (TQ + cụ thể với KPI):
   → KPI đo được: % giảm thời gian, số người dùng, mức tự động hoá, tỷ lệ trực tuyến?

10. [§4.2-4.4] Quy mô + Thời gian + Hình thức đầu tư:
    a) Quy mô (số đơn vị, số người dùng, giao dịch/năm)?
    b) Thời gian thực hiện (năm BĐ — năm KT)?
    c) Hình thức: đầu tư mới / nâng cấp / mở rộng / thuê dịch vụ CNTT?

═══ Chương 5-6 — Địa điểm + Phương án CN ═══

11. [§5] Địa điểm: TTDL ở đâu? Yêu cầu vỏ trạm — đường truyền — điện?

12. [§6.4] Phương án công nghệ tổng thể:
    a) Mạng (3-lớp truyền thống vs Spine&Leaf)?
    b) Tường lửa (NGFW + WAF, hãng dự kiến)?
    c) Lưu trữ (DAS/NAS/SAN, ước dung lượng)?
    d) Máy chủ (rack/blade/HCI)?
    e) Ảo hoá (VMware/KVM/Hyper-V)?
    f) SIEM + giám sát mạng (vendor)?

13. [§6.5] Phần mềm nội bộ:
    a) Ngôn ngữ (Java/.NET Core)?
    b) Frontend (React/Angular/Vue)?
    c) CSDL (PostgreSQL/Oracle/MS SQL)?
    d) Kiến trúc (Monolith/Microservice/N-Tier)?

14. [§6.6] Phần mềm thương mại (COTS): có cần Office/AV/VPN client/quản trị?

═══ Chương 7-8 — Mô hình + Định cỡ ═══

15. [§7] Mô hình kiến trúc:
    a) Phân vùng: vùng trong / vùng ngoài / vùng trung gian?
    b) Sơ đồ tổng thể, sơ đồ logic, sơ đồ vật lý cho từng vùng?
    → Yêu cầu 5 sơ đồ §7 (sẽ generate qua doc-diagram)

16. [§8.1] Định cỡ (sizing) — số liệu đầu vào:
    a) Số người dùng đồng thời (concurrent)?
    b) Số transaction/giây mục tiêu?
    c) Dung lượng dữ liệu/năm?
    d) RPO / RTO?

17. [§8.5] Đào tạo: đối tượng (cán bộ nghiệp vụ / quản trị / CNTT)? Số lượng? Thời lượng?

═══ Chương 9 — ATTT cấp độ ═══

18. [§9.1] Cấp độ ATTT của hệ thống (NĐ 85/2016 Đ7 — 5 tiêu chí):
    → Đề xuất cấp độ N? Ai phê duyệt?
    → 5 nhóm biện pháp TCVN 11930 (quản lý / kỹ thuật / vật lý / con người / vận hành)?

═══ Chương 10-11 — Quản lý + ANQP ═══

19. [§10] Phương pháp QLDA + khai thác:
    a) Hình thức QLDA (BQL chuyên trách / kiêm nhiệm / thuê tư vấn)?
    b) Tổ chức vận hành sau bàn giao (đơn vị nào, biên chế)?
    c) Giám sát theo Luật An ninh mạng?

20. [§11] PCCC + ANQP: yêu cầu khu vực thi công, an toàn vận hành?

═══ Chương 13-14 — Tiến độ + Tổng mức đầu tư ═══

21. [§13] Tiến độ: liệt kê các mốc chính (khảo sát, TKCS, TKCT, đấu thầu,
    triển khai, vận hành thử, nghiệm thu)?

22. [§14] Tổng mức đầu tư:
    a) Sơ bộ tổng mức (tỷ đồng)?
    b) Cơ cấu nguồn vốn (NSNN/ODA/PPP/khác)?
    c) Phân bổ theo TT 04/2020: PCCN / TBVT / cài đặt / đào tạo / quản lý / dự phòng?

═══ Chương 15-16 — Bảo hành + Tổ chức ═══

23. [§15] Bảo hành + chi phí O&M:
    a) Thời gian bảo hành (12/24/36 tháng)?
    b) Chi phí bảo trì/năm sau bảo hành?

24. [§16] Tổ chức QLDA: chủ đầu tư, BQLDA, các đơn vị phối hợp,
    trách nhiệm cụ thể (Bộ/Tỉnh, Cục, Vụ, Sở)?

═══ Chương 17-18 — Hiệu quả + Rủi ro ═══

25. [§17 + §18] Hiệu quả + Rủi ro:
    a) Hiệu quả KT-XH (định lượng): giảm % thời gian, tăng % giao dịch trực tuyến,
       số người dân/doanh nghiệp thụ hưởng?
    b) Hiệu quả ANQP (nếu có)?
    c) Rủi ro chính (≥ 5): ngân sách / tiến độ / yêu cầu / ATTT / năng lực nhà thầu?
    d) Biện pháp giảm thiểu cụ thể cho từng rủi ro (≥ 5 dòng cho ma trận §18.1)?
```

**Skip rules**:
- Q1-Q3 + Q15 + Q22 + Q24 = bắt buộc, không skip.
- Q5b, Q6c, Q12, Q14, Q16 có thể inherit từ Đề án CĐS / TKCS đã có (nếu có).
- Q15 (sơ đồ): không cần user vẽ — doc-diagram tự sinh từ data + KB pattern.
- Section dạng Phụ lục PL.1-PL.3 chỉ cần user xác nhận có TTDL hiện trạng + sơ đồ mạng kế thừa hay không.
