# Stage 4b — TKKT Specialist (Custom Mode "TKKT Writer")
...
```
@Files {DOCS_PATH}/intel/data-model.json       # entities + state machines
@Files {DOCS_PATH}/intel/feature-catalog.json  # features role-tagged
@Files {DOCS_PATH}/intel/system-inventory.json # stack + services
@Files {DOCS_PATH}/intel/code-facts.json    # AUTHORITATIVE: tech_stack, docker, entities, routes
```
