...
Hướng dẫn đóng góp vào team-ai-config — agent mới, skill mới, sửa lỗi, hoặc cải tiến CLI.
...
- [architecture](architecture.md) — Hiểu LIFECYCLE contract + production line
- [decision-log](decision-log.md) — Hiểu các quyết định kiến trúc lớn
- [glossary](glossary.md) — Đồng nhất thuật ngữ
...
→ Chi tiết: [maintainer](maintainer.md).
...
Đọc [glossary](glossary.md) trước. Đồng nhất thuật ngữ giúp grep dễ.
...
Quy trình: xem [maintainer](maintainer.md).
